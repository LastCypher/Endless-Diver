...
function preload() {
    ...
    this.load.atlas('scuba','assets/bird-yellow-sprite.png','assets/bird-yellow-sprite.json');
    // Numbers
...
function makePipes(scene) {
    ...
    const gap = scene.add.line(288, pipeTopY + 250, 0, 0, 0, 150)
    gapsGroup.add(gap)
